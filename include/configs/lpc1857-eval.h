 ...
 * This is a modified port of LPC1850 
 *
...
/*
 * Configuration settings for the Hitex LPC1857 Eval board.
 */
...
/*
 * This is the NXP LPC1857 device, part of the LPC18xx series
 */
 ...
 * Monitor prompt
 */
#define CONFIG_SYS_PROMPT		"LPC1857> "
 ...
 */
/*
 * No internal flash on the NXP LPC1857 MCU. Setting CONFIG_MEM_NVM_LEN to the
 * size of the contiguous region of internal SRAM at address 0x20000000.
 */
#define CONFIG_MEM_NVM_BASE		0x20000000 // 64kB flash on LPC1857
#define CONFIG_MEM_NVM_LEN		(64 * 1024)

/* .rodata is written here */
/* NOTE: These are defined in u-boot.lds in the board directory */
/*#define CONFIG_MEM_NVM2_BASE		0x10000000 // 32kB flash on LPC1857 */
/*#define CONFIG_MEM_NVM2_LEN		(32 * 1024) */

#define CONFIG_MEM_RAM_BASE		0x10080000 // 40kB on LPC1857
#define CONFIG_MEM_RAM_LEN		(20 * 1024) //(32 * 1024)
#define CONFIG_MEM_RAM_BUF_LEN		(1 * 1024) //(1 * 1024)
#define CONFIG_MEM_MALLOC_LEN		(15 * 1024) //(27 * 1024)
#define CONFIG_MEM_STACK_LEN		(4 * 1024) //(4 * 1024)
 ...
 */
#undef CONFIG_MEM_ETH_DMA_BUF_BASE//	0x10080000	/* Region of SRAM */
/*
...
#undef CONFIG_LPC18XX_ETH
#undef CONFIG_LPC18XX_ETH_DIV_SEL	//4	/* 150-250 MHz */
